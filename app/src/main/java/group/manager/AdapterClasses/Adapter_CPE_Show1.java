...
public class Adapter_CPE_Show1 extends ArrayAdapter<RowItem_CPE_Show1> {
	...
	private class ViewHolder {
		TextView txtCpeYear,txtCpeTotalHrs;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.txtCpeYear = (TextView) convertView.findViewById(R.id.txt1);
			holder.txtCpeTotalHrs = (TextView) convertView.findViewById(R.id.txt2);
