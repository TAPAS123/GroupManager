...
public class AdminEventList extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		desc=temp1[0].toString();
		StrNUm1=temp1[1].toString();
		//System.out.println(val2+" "+val3+" "+val4+" "+Str_Mid+" "+desc+" "+StrNUm1+"  "+StrNum3);
		TXtdesc.setText(val4);
		TXTven.setText(val2);//Set Venue
	...
	private void back(){
	  Intent MainBtnIntent= new Intent(getBaseContext(),EventCalendar.class);	
