...
import group.manager.AdapterClasses.Adapter_CPE_Program_1;
...
public class CPE_Program_1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LV1 = (ExpandableListView) findViewById(R.id.LV1);
		...
		txtHead.setText(MTitle.toUpperCase());//set Cpe title
		...
		LV1.setOnGroupCollapseListener(new ExpandableListView.OnGroupCollapseListener() {
			@Override
		...
		LV1.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
			@Override
	...
	private void Display_ListData() {
		...
		Adapter_CPE_Program_1 adapter = new Adapter_CPE_Program_1(context, categories, LV1);
