...
public class CPE_Program_2 extends Activity{
	...
	TextView txtProg_Name,txt_LDate,txt_LTime,txt_LVenue,txt_LOrg_By,txt_LCpe_Hrs,txt_LFees,txt_LRemark;
	boolean flag=false;
	ImageView ImgVw_Ad;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		txtProg_Name=(TextView) findViewById(R.id.tvCpe_Prog_Name);
		...
		txtProg_Name.setText(LProg_Name); // Set Program Name
	...
	public void backs()
	{
	  /*if(!flag)
	  {
	    Intent MainBtnIntent= new Intent(context,CPE_Program_1.class);
