...
public class ClubSync  extends Activity {
	...
	Connection conn;
	String ClientId, Log, ClubName, logid, Tab2Name, Tab4Name, Tab5Name, TabMiscName, StrChkEny,
			TabFamilyName, TabOp1Name, TabOp2Name, UID = "", ChkSync = "", CurrentDT_Diff, SyncDT, TablesInfo;
	...
	Cursor cursorT;
	int Tab2Count, Tab4Count, TabMiscCount, Tab2Max_Mid, Tab4Max_Mid, TabMiscMax_Mid, Tab2Min_Sync,
			Tab4Min_Sync, TabMiscMin_Sync, Tab2Min_SyncDT, Tab4Min_SyncDT, TabMiscMin_SyncDT, TabFamilyMax_Mid,
			TabFamilyCount, TabFamilyMin_Sync, TabFamilyMin_SyncDT, TabOp1Max_Mid, TabOp1Count, TabOp1Min_Sync,
			TabOp1Min_SyncDT, TabOp2Max_Mid, TabOp2Count, TabOp2Min_Sync, TabOp2Min_SyncDT;
	byte[] AppLogo;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		dialog.setTitle(Html.fromHtml("<font color='#008000'>Sync ( 1/7 )</font>"));
	...
	private void ProgressBar(int RecordCount, String TableName) {
		...
		dialog.setTitle(Html.fromHtml("<font color='#008000'>Sync ( " + i + "/7 )</font>"));
