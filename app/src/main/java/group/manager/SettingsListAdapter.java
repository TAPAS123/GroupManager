...
public class SettingsListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        TextView textViewname = (TextView) view.findViewById(R.id.grp_child);
        //"i" is the position of the parent/group in the list and 
        //"i1" is the position of the child
        textView.setText(mParent.get(i).children.get(i1).name);    
        textViewname.setText(mParent.get(i).children.get(i1).val2);    
        //System.out.println(mParent.get(i).selection);
        ImageView iv= (ImageView) view.findViewById(R.id.imageViewpix);
        if(mParent.get(i).children.get(i1).Image==null){
        	iv.setImageResource(R.drawable.person1);
        }else{
        	iv.setImageBitmap(mParent.get(i).children.get(i1).Image);	
        }
